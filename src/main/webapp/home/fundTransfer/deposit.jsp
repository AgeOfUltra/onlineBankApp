...
<head>
  ...
  <title>Deposit form | Srikanth Bank </title>
...
<div class="container">
  <div class="login form">
    <header>Deposit Form</header>
    <form action="<%=request.getContextPath()%>/home/fundTransfer/deposit" method="post">
      <label>
      ...
      <label>
        <input type="number" name="dept_amount" placeholder="Enter your Deposit amount">
      </label>
